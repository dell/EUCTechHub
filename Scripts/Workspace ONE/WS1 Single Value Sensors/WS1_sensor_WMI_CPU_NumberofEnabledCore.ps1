# Returns value for CPU NumberofEnabledCore
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU NumberofEnabledCore
...
$OutputStatement = $CPU_EnbCores_Value
