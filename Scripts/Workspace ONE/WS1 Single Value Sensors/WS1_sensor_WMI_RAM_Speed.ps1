# Returns value for Count RAM  Speed
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_PhysicalMemory. Select Value for Count RAM Speed
...
$OutputStatement = $RAM_Speed_Value
