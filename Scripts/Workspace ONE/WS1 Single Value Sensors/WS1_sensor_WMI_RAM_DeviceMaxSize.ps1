# Returns value for Device Max RAM Size
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_PhysicalMemoryArray. Select Value for Device Max RAM Size
