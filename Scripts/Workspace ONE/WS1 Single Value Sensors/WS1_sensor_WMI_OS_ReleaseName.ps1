# Returns value for OS Release Name
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI Win32_OperatingSystem. Select Value for OS Version and translate NameID to Offical ReleaseName.
...
$OutputStatement = $OS_Version_Value
