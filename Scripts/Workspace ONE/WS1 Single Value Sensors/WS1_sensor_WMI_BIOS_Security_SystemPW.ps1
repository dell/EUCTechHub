# Returns value for BIOS Security SystemPW
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI WMI Namespace root/DCIM/SYSMAN/wmisecurity -ClassName PasswordObject. Select Value for BIOS Security SystemPW.
...
$OutputStatement = $Security_SystemPW_Value
