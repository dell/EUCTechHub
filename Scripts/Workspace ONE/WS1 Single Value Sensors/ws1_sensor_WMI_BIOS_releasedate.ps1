# Returns value for BIOS ReleaseDate
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI Win32_BIOS Class. Select Value for BIOS ReleaseDate.
...
$OutputStatement = $BIOS_ReleaseDate_Value.ToShortDateString()
