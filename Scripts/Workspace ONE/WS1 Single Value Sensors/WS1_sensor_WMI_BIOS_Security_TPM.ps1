# Returns value for BIOS Security TPM
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI -Namespace root/DCIM/SYSMAN/biosattributes -ClassName EnumerationAttribute. Select Value for BIOS Security TPM.
...
$OutputStatement = $Security_TPM_Value
