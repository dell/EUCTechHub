# Returns value for CPU Manufacturer
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU Manufacturer
...
$OutputStatement = $CPU_Manufacturer_Value
