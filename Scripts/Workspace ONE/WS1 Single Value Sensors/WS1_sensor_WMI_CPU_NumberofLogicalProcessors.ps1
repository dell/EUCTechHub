# Returns value for CPU NumberofLogicalProcessors
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU NumberofLogicalProcessors
...
$OutputStatement = $CPU_LogProcessors_Value
