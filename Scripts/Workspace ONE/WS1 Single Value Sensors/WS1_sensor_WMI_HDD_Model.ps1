...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_DiskDrive. Select Value for HDD Model
...
foreach($i in $HDD_Data)
    ...
    $HDD = $HDD+$HDD_DeviceID_Value[$IndexCounter]+" "+$HDD_Model+$HDD_Model_Value[$IndexCounter]+" "
