# Returns value for Battery HealthState
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Dell Command | Monitor to collect values from DCIM_Battery Class. Select Value for BatteryHealth.
...
if (($Check_Chassis_Type -eq 10) -or ($Check_Chassis_Type -eq 31) -or ($Check_Chassis_Type -eq 32))
    ...
    $OutputStatement = $DCM_Battery_HealthState_Value
    }
Else
    {
