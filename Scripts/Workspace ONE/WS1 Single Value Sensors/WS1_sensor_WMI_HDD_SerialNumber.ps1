# Returns value for HDD SerialNumber
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_DiskDrive. Select Value for HDD SerialNumber
...
foreach($i in $HDD_Data)
    ...
    $HDD = $HDD+$HDD_DeviceID_Value[$IndexCounter]+" "+$HDD_SerialNumber+$HDD_SerialNumber_Value[$IndexCounter]+" "
