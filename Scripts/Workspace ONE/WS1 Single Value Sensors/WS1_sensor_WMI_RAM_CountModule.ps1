# Returns value for Count RAM Module
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_PhysicalMemory. Select Value for Count RAM Module
...
$OutputStatement = $RAM_ModulCount_Value
