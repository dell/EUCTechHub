# Returns value for Count RAM Module Size
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_PhysicalMemory. Select Value for Count RAM Module Size
...
$OutputStatement = $RAM_Capacity_Value
