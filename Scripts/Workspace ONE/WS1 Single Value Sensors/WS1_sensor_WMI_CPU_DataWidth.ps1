# Returns value for CPU DataWidth
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU DataWidth
...
$CPU_DataWidth_Value = $CPU_Data.DataWidth.ToString()

$CPU_DataWidth_Value = $CPU_DataWidth_Value+" BIT"

#prepare string for output
$OutputStatement = $CPU_DataWidth_Value
