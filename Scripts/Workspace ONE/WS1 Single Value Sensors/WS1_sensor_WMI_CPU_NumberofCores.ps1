# Returns value for CPU NumberofCores
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU NumberofCores
...
$OutputStatement = $CPU_NoCores_Value
